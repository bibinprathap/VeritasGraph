    ...
    def __init__(self, config=None, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional configuration options:
                - base_uri: Base URI for ontology (default: "https://veritasreason.dev/ontology/")
...
class SHACLGenerator:
    """
    Generates SHACL shapes from VeritasReason OWL ontology dicts.
    ...
    def __init__(
        self,
        base_uri: str = "https://veritasreason.dev/shapes/",
    ...
    def generate(self, ontology: Dict[str, Any], **options) -> SHACLGraph:
        """Generate a SHACLGraph from a VeritasReason ontology dict."""
