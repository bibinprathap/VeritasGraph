...
for the VeritasReason framework, supporting text content with multiple embedding models
...
Example Usage:
    >>> from veritasreason.embeddings import embed_text, calculate_similarity
