...
property graph storage and Cypher querying in the VeritasReason framework, supporting
...
Note:
    ...
    - Semantic IDs can be stored in the ``veritasreason_id`` property.
...
class ApacheAgeStore:
    ...
    - ID separation (AGE internal vs semantic ``veritasreason_id``)
    """
    ...
    def __init__(
        ...
        **config,
        ...
        self.graph_name = graph_name or config.get("graph_name", "veritasreason")
    ...
    def create_node(
        ...
        **options,
        ...
        If ``veritasreason_id`` is present in *properties* it is preserved as-is;
