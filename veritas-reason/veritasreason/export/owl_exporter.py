...
for the VeritasReason framework, enabling ontology export for semantic modeling.
...
class OWLExporter:
    ...
    def __init__(
        self,
        ontology_uri: str = "https://veritasreason.dev/ontology/",
        version: str = "1.0",
        format: str = "owl-xml",
        ...
        **kwargs,
        ...
        Args:
            ontology_uri: Base URI for the ontology (default: "https://veritasreason.dev/ontology/")
    ...
    def _export_owl_xml(self, ontology: Dict[str, Any], **options) -> str:
        ...
        ontology_name = ontology.get("name", "VeritasReasonOntology")
    ...
    def export_classes(
        ...
        ontology_name: str = "VeritasReasonOntology",
        **options,
    ) -> None:
        """
        ...
        Args:
            ...
            ontology_name: Ontology name (default: "VeritasReasonOntology")
