...
Note: For conflict detection and resolution, use the `veritasreason.conflicts` module.
For deduplication, use the `veritasreason.deduplication` module.
...
```python
from veritasreason.kg import GraphBuilder, GraphAnalyzer, NodeEmbedder, SimilarityCalculator, PathFinder, LinkPredictor
...
# For advanced conflict resolution, consider using the veritasreason.conflicts module directly.
builder = GraphBuilder(
    merge_entities=True,
    entity_resolution_strategy="fuzzy",
    resolve_conflicts=True,
...
```python
from veritasreason.kg import algorithm_registry
...
```python
from veritasreason.kg import NodeEmbedder
...
```python
import numpy as np
from veritasreason.kg import NodeEmbedder, SimilarityCalculator
...
```python
from veritasreason.kg import SimilarityCalculator
...
```python
from veritasreason.kg import PathFinder
...
```python
from veritasreason.kg import LinkPredictor
...
```python
from veritasreason.kg import GraphAnalyzer, CentralityCalculator
...
```python
from veritasreason.kg import GraphAnalyzer, CentralityCalculator, CommunityDetector, ConnectivityAnalyzer
...
```python
from veritasreason.kg import EntityResolver
...
```python
from veritasreason.kg import analyze_connectivity, ConnectivityAnalyzer
...
```python
from veritasreason.kg import analyze_connectivity
...
```python
from veritasreason.kg import TemporalGraphQuery
...
```python
from veritasreason.kg.methods import (
    build_kg,
    analyze_graph,
    resolve_entities,
    detect_conflicts,
...
```python
from veritasreason.kg.methods import get_kg_method
...
```python
from veritasreason.kg.methods import list_available_methods
...
```python
from veritasreason.kg.registry import method_registry
...
# Use custom method
from veritasreason.kg.methods import build_kg
...
```python
from veritasreason.kg.registry import algorithm_registry
...
from veritasreason.kg.methods import compute_node_embeddings
...
```python
from veritasreason.kg.registry import method_registry, algorithm_registry
...
```python
from veritasreason.kg.config import kg_config
...
```python
from veritasreason.kg.config import KGConfig
