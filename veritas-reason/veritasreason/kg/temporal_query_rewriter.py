...
components (e.g. :class:`~veritasreason.context.context_retriever.TemporalGraphRetriever`)
...
class TemporalQueryRewriter:
    ...
    **Regex-only** (default, no LLM required)
        ...
        :class:`~veritasreason.kg.temporal_normalizer.TemporalNormalizer`
    ...
    **LLM-assisted** (``llm_provider`` kwarg)
        ...
        :class:`~veritasreason.kg.temporal_normalizer.TemporalNormalizer` so the
    ...
    .. warning::
        ...
        performed by
        :class:`~veritasreason.context.context_retriever.TemporalGraphRetriever`.
    """
