...
for the VeritasReason framework, enabling standardization and quality improvement
...
Example Usage:
    >>> from veritasreason.normalize import normalize_text, normalize_entity, normalize_date, TextNormalizer
