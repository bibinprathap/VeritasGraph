"""
VeritasReason Explorer FastAPI application factory.
"""
...
def create_app(session: Optional[GraphSession] = None) -> FastAPI:
    ...
    app = FastAPI(
        title="VeritasReason Knowledge Explorer",
        description="Interactive dashboard API for exploring VeritasReason knowledge graphs.",
        version=__version__,
        lifespan=lifespan,
    )
    ...
    async def root():
        ...
        return HTMLResponse(
            ...
            '<title>VeritasReason Knowledge Explorer</title></head>'
