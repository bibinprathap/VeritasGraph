...
IMPORTANT: This module now uses the unified veritasreason.provenance.ProvenanceManager
...
class ProvenanceTracker:
    ...
    This class now wraps veritasreason.provenance.ProvenanceManager for enhanced
