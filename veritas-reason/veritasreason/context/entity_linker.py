...
Example Usage:
    >>> from veritasreason.context import EntityLinker
...
class EntityLinker:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None, **kwargs):
        ...
        self.base_uri = self.config.get("base_uri", "https://veritasreason.dev/entity/")
    ...
    def resolve_uri(self, uri: str) -> Optional[Dict[str, Any]]:
        ...
        Example:
            >>> entity = linker.resolve_uri("https://veritasreason.dev/entity/python")
        """
