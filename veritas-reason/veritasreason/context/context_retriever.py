...
Graph Retrieval:
    ...
    - Relationship-Aware Matching: Finding entities through veritasreasonlly relevant relationships
...
Key Features:
    ...
    - Graph Expansion: Multi-hop traversal following veritasreasonlly relevant paths
...
Example Usage:
    >>> from veritasreason.context import ContextRetriever
...
class ContextRetriever:
                ...
                try:
                    ...
                    if query_embedding is not None:
                        ...
                        if query_norm > 0:
                                ...
                                if entity_embedding is not None:
                                    ...
                                    if entity_norm > 0:
                                        ...
                                        if query_intent and query_intent.get("entity_types"):
                                            # Check if entity type veritasreasonlly matches query keywords
                            ...
                            # Also match relationships veritasreasonlly
                            relationship_scores = []
                            for rel in relationships:
                                ...
                                if rel_embedding is not None:
                                    ...
                                    if rel_norm > 0:
                                        ...
                                        # Boost if relationship type veritasreasonlly matches query (domain-agnostic)
    ...
    def _extract_query_intent(self, query: str) -> Dict[str, Any]:
        ...
        # Note: Entity types are not hardcoded - they will be matched veritasreasonlly
    ...
    def _generate_reasoned_response(
        ...
        Args:
            ...
            llm_provider: LLM provider instance (from veritasreason.llms)
...
Answer:"""
    ...
    def query_with_reasoning(
        ...
        **kwargs,
        ...
        Example:
            >>> from veritasreason.llms import Groq
...
class TemporalGraphRetriever:
    ...
    :meth:`~veritasreason.kg.temporal_query.TemporalGraphQuery.reconstruct_at_time`.
    ...
    Example::
        ...
        from veritasreason.context import ContextRetriever, TemporalGraphRetriever
    ...
    def __init__(
        ...
        Args:
            ...
            at_time: Default point-in-time for temporal filtering. Accepts a
                ...
                :func:`~veritasreason.kg.temporal_model.parse_temporal_value`
        ...
        Example:
            ...
            >>> from veritasreason.kg import TemporalQueryRewriter
        ...
        if not _TEMPORAL_AVAILABLE:
            raise ImportError(
                "TemporalGraphRetriever requires the veritasreason.kg temporal modules "
