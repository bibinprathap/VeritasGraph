...
Example Usage:
    >>> from veritasreason.context import DecisionQuery
...
class DecisionQuery:
    ...
    def __init__(
        ...
        Args:
            ...
            advanced_analytics: Enable advanced graph analytics (requires veritasreason.kg)
            node_embeddings: Enable Node2Vec embeddings (requires veritasreason.kg)
            centrality_analysis: Enable centrality measures (requires veritasreason.kg)
            community_detection: Enable community detection (requires veritasreason.kg)
            link_prediction: Enable link prediction (requires veritasreason.kg)
        """
