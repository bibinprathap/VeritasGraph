...
Main exports:
    - VeritasReason: Main framework class
    - PipelineBuilder: Pipeline construction DSL
    - Config: Configuration management
"""

__version__ = "0.4.6"
__author__ = "VeritasReason Contributors"
__license__ = "MIT"
...
# Core imports
# from .core import Config, ConfigManager, LifecycleManager, PluginRegistry, VeritasReason
...
class _ModuleProxy:
    ...
    def _get_module(self):
        ...
        if self._module is None:
            self._module = importlib.import_module(f"veritasreason.{self._module_name}")
        return self._module
...
_modules = _VeritasReasonModules()
...
def __getattr__(name: str):
    ...
    raise AttributeError(f"module 'veritasreason' has no attribute '{name}'")
