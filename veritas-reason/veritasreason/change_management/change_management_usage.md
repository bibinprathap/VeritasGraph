...
This guide demonstrates how to use the Enhanced Change Management module for version control, audit trails, and compliance tracking in VeritasReason.
...
```python
from veritasreason.change_management import VersionStorage, InMemoryVersionStorage, SQLiteVersionStorage
...
```python
from veritasreason.change_management import VersionStorage
...
```python
from veritasreason.change_management import TemporalVersionManager, ChangeLogEntry
...
```python
from veritasreason.change_management import compute_checksum, verify_checksum
...
from veritasreason.kg.temporal_query import TemporalVersionManager
