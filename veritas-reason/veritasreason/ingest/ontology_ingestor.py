...
and convert them into VeritasReason's internal ontology dictionary format.
...
Key Features:
    ...
    - Conversion to VeritasReason ontology structure
...
class OntologyIngestor:
    ...
    This class parses OWL/RDF files and converts them to VeritasReason's ontology dictionary format.
    """
    ...
    def _convert_to_dict(self, graph: Graph, source_path: str, format: str = "unknown") -> Dict[str, Any]:
        """
        Convert rdflib Graph to VeritasReason ontology dictionary.
            ...
            for s, p, o in graph.triples((None, RDF.type, c_type)):
                ...
                if uri not in classes:
                    ...
                    if label:
                        ...
                        # But VeritasReason seems to use "name" for the identifier in some examples.
