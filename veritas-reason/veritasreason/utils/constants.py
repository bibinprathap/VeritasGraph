...
This module provides constants and configuration values for the VeritasReason framework,
...
Example Usage:
    >>> from veritasreason.utils import SUPPORTED_DOCUMENT_FORMATS, DEFAULT_CONFIG
    ...
    >>> 
    >>> from veritasreason.utils import ERROR_CODES, PERFORMANCE_THRESHOLDS
...
# API Endpoints
API_ENDPOINTS = {
    "BASE_URL": "https://api.veritasreason.dev",
    "VERSION": "v1",
    "ENDPOINTS": {
        "PROCESS": "/process",
        "EXTRACT": "/extract",
