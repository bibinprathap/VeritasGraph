...
This module provides shared utilities and helper functions for the VeritasReason framework,
...
Main Classes:
    ...
    - Exception classes: VeritasReasonError, ValidationError, ProcessingError, ConfigurationError, QualityError
...
Example Usage:
    ...
    >>> 
    >>> from veritasreason.utils import ValidationError, validate_entity
    >>> entity = {"id": "e1", "text": "John Doe", "type": "PERSON"}
    >>> is_valid, error = validate_entity(entity)
    >>> 
    >>> from veritasreason.utils import clean_text, merge_dicts
