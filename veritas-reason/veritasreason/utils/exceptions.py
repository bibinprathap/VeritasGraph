...
This module provides comprehensive exception handling for the VeritasReason framework,
...
Key Features:
    - Custom exception hierarchy with base VeritasReasonError class
...
Main Classes:
    - VeritasReasonError: Base exception class for all framework errors
...
Example Usage:
    >>> from veritasreason.utils import ValidationError, ProcessingError
    >>> try:
    ...     if not is_valid:
    ...
    >>> 
    >>> from veritasreason.utils import handle_exception, format_exception
    >>> try:
    ...     process_data(data)
...
class VeritasReasonError(Exception):
    """
    Base exception class for all VeritasReason framework errors.
    ...
    def __init__(
        ...
        """
        Initialize VeritasReason error.
...
class ValidationError(VeritasReasonError):
    """
...
class ProcessingError(VeritasReasonError):
    """
...
class ConfigurationError(VeritasReasonError):
    """
...
class QualityError(VeritasReasonError):
    """
...
def handle_exception(
    ...
    if isinstance(exception, VeritasReasonError):
