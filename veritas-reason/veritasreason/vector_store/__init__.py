...
VeritasReason framework, including support for multiple vector store backends (FAISS,
...
Configuration:
    - Environment variables (VERITASREASON_VECTOR_STORE_*)
...
Example Usage:
    >>> from veritasreason.vector_store import VectorStore, store_vectors, search_vectors, hybrid_search
