...
import pytest
from veritasreason.change_management import (
    TemporalVersionManager,
    OntologyVersionManager,
    ChangeLogEntry
)
from veritasreason.change_management.change_log import generate_change_report, ChangeLogAnalyzer
from veritasreason.change_management.ontology_version_manager import VersionManager
