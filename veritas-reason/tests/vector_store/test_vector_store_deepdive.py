...
from veritasreason.vector_store.vector_store import VectorStore, VectorIndexer, VectorRetriever, VectorManager
from veritasreason.vector_store.registry import MethodRegistry, method_registry
from veritasreason.vector_store.faiss_store import FAISSStore, FAISSIndex, FAISSIndexBuilder, FAISSSearch
from veritasreason.vector_store.milvus_store import MilvusStore, MilvusClient, MilvusCollection, MilvusSearch
from veritasreason.vector_store.qdrant_store import QdrantStore
from veritasreason.vector_store.weaviate_store import WeaviateStore
from veritasreason.vector_store.hybrid_search import HybridSearch, MetadataFilter, SearchRanker
...
class TestVectorStoreDeepDive(unittest.TestCase):
    ...
    @patch('veritasreason.vector_store.faiss_store.faiss')
    @patch('veritasreason.vector_store.faiss_store.FAISS_AVAILABLE', True)
    ...
    @patch('veritasreason.vector_store.milvus_store.connections')
    @patch('veritasreason.vector_store.milvus_store.Collection')
    @patch('veritasreason.vector_store.milvus_store.utility')
    @patch('veritasreason.vector_store.milvus_store.DataType')
    @patch('veritasreason.vector_store.milvus_store.FieldSchema')
    @patch('veritasreason.vector_store.milvus_store.CollectionSchema')
    @patch('veritasreason.vector_store.milvus_store.MILVUS_AVAILABLE', True)
    ...
    @patch('veritasreason.vector_store.qdrant_store.QdrantClientLib')
    @patch('veritasreason.vector_store.qdrant_store.VectorParams')
    @patch('veritasreason.vector_store.qdrant_store.Distance')
    @patch('veritasreason.vector_store.qdrant_store.PointStruct')
    @patch('veritasreason.vector_store.qdrant_store.QDRANT_AVAILABLE', True)
    ...
    @patch('veritasreason.vector_store.weaviate_store.weaviate')
    @patch('veritasreason.vector_store.weaviate_store.MetadataQuery')
    @patch('veritasreason.vector_store.weaviate_store.WEAVIATE_AVAILABLE', True)
