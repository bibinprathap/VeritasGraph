...
from veritasreason.seed.seed_manager import SeedDataManager, SeedDataSource, SeedData
...
@patch("veritasreason.ingest.db_ingestor.DBIngestor")
...
def test_load_from_database_import_error(seed_manager):
    with patch.dict("sys.modules", {"veritasreason.ingest.db_ingestor": None}):
