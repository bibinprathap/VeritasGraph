...
class TestComputeNodeEmbeddings:
    ...
    @patch('veritasreason.kg.methods.NodeEmbedder')
...
class TestCalculateSimilarity:
    ...
    @patch('veritasreason.kg.methods.SimilarityCalculator')
    ...
    def test_calculate_similarity_missing_embeddings(self, mock_calculator_class):
        ...
        with patch('veritasreason.kg.methods._get_node_embedding', side_effect=mock_get_embedding):
...
class TestPredictLinks:
    ...
    @patch('veritasreason.kg.methods.LinkPredictor')
...
class TestFindShortestPath:
    ...
    @patch('veritasreason.kg.methods.PathFinder')
...
class TestCalculatePageRank:
    ...
    @patch('veritasreason.kg.methods.CentralityCalculator')
...
class TestDetectCommunitiesLabelPropagation:
    ...
    @patch('veritasreason.kg.methods.CommunityDetector')
