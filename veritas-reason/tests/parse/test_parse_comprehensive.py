...
from veritasreason.parse.document_parser import DocumentParser, PDFParser, DOCXParser, HTMLParser
from veritasreason.parse.pptx_parser import PPTXParser
from veritasreason.parse.excel_parser import ExcelParser
from veritasreason.parse.structured_data_parser import StructuredDataParser, JSONParser, CSVParser, XMLParser
from veritasreason.parse.email_parser import EmailParser
from veritasreason.parse.code_parser import CodeParser
from veritasreason.parse.media_parser import MediaParser, ImageParser
from veritasreason.parse.web_parser import WebParser
from veritasreason.parse.registry import MethodRegistry
...
class TestParseComprehensive(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patchers = []
        modules_to_patch = [
            'veritasreason.parse.document_parser',
            'veritasreason.parse.structured_data_parser',
            'veritasreason.parse.email_parser',
            'veritasreason.parse.code_parser',
            'veritasreason.parse.media_parser',
            'veritasreason.parse.web_parser',
            'veritasreason.parse.pdf_parser',
            'veritasreason.parse.docx_parser',
            'veritasreason.parse.pptx_parser',
            'veritasreason.parse.excel_parser',
            'veritasreason.parse.html_parser',
            'veritasreason.parse.json_parser',
            'veritasreason.parse.csv_parser',
            'veritasreason.parse.xml_parser',
            'veritasreason.parse.image_parser'
        ]
    ...
    @patch('veritasreason.parse.pdf_parser.pdfplumber')
    ...
    @patch('veritasreason.parse.docx_parser.Document')
