import unittest
from veritasreason.reasoning.sparql_reasoner import SPARQLReasoner, SPARQLQueryResult
from veritasreason.reasoning.abductive_reasoner import AbductiveReasoner, Observation, HypothesisRanking
from veritasreason.reasoning.deductive_reasoner import DeductiveReasoner, Premise, Argument
from veritasreason.reasoning.reasoner import Rule
...
class TestSpecializedReasoners(unittest.TestCase):
    ...
    def test_abductive_reasoner_rank_hypotheses(self):
        ...
        from veritasreason.reasoning.abductive_reasoner import Hypothesis
