...
from veritasreason.embeddings.embedding_generator import EmbeddingGenerator
...
class TestModelSwitching(unittest.TestCase):
    ...
    def test_fallback_on_switch_failure(self):
        ...
        with patch('veritasreason.embeddings.text_embedder.FASTEMBED_AVAILABLE', False):
