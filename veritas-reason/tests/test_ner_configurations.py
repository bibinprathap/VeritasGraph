...
from veritasreason.semantic_extract.named_entity_recognizer import NamedEntityRecognizer
from veritasreason.semantic_extract.methods import get_entity_method
...
class TestNERConfigurations(unittest.TestCase):
    ...
    @patch('veritasreason.semantic_extract.methods.spacy')
    def test_ner_ml_config_spacy_available(self, mock_spacy):
        ...
        with patch('veritasreason.semantic_extract.methods.SPACY_AVAILABLE', True):
    ...
    @patch('veritasreason.semantic_extract.ner_extractor.spacy')
    def test_ner_ml_init_falls_back_when_spacy_runtime_is_broken(self, mock_spacy):
        ...
        with patch('veritasreason.semantic_extract.ner_extractor.SPACY_AVAILABLE', True):
    ...
    @patch('veritasreason.semantic_extract.methods.HuggingFaceModelLoader')
