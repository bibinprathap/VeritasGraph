...
from veritasreason.ingest import MCPIngestor, ingest_mcp, DBIngestor, FileIngestor
from veritasreason.ingest.mcp_ingestor import MCPData
...
class TestCookbookIntegration:
    ...
    def test_financial_data_integration(self, mock_mcp_server):
        ...
        with patch("veritasreason.ingest.mcp_ingestor.get_progress_tracker") as mock_tracker:
