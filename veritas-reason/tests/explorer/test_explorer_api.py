...
from veritasreason.explorer.app import create_app
from veritasreason.explorer.session import GraphSession

try:
    from starlette.testclient import TestClient
except ImportError:
    pytest.skip(
        "starlette TestClient is required for explorer tests. Install veritas-reason[explorer].",
...
class TestHealthInfo:
    ...
    def test_info(self, client):
        ...
        assert payload["name"] == "VeritasReason Knowledge Explorer"
...
from veritasreason.utils.helpers import classify_path_distance
