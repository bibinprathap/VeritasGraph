...
from veritasreason.ontology.ontology_evaluator import OntologyEvaluator, EvaluationResult
from veritasreason.ontology.competency_questions import CompetencyQuestionsManager, CompetencyQuestion
from veritasreason.change_management import VersionManager, OntologyVersion
from veritasreason.ontology.associative_class import AssociativeClassBuilder, AssociativeClass
from veritasreason.ontology.reuse_manager import ReuseManager
...
class TestOntologyAdvanced(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patchers = [
            ...
            patch('veritasreason.ontology.competency_questions.get_logger', return_value=self.mock_logger),
            patch('veritasreason.ontology.competency_questions.get_progress_tracker', return_value=self.mock_tracker),
            ...
            patch('veritasreason.ontology.associative_class.get_logger', return_value=self.mock_logger),
            patch('veritasreason.ontology.associative_class.get_progress_tracker', return_value=self.mock_tracker),
        ]
    ...
    @patch('veritasreason.change_management.ontology_version_manager.NamespaceManager')
...
class TestSHACLHierarchicalAndValidation(unittest.TestCase):
    ...
    def test_engine_to_shacl_returns_non_empty_string(self):
        ...
        with patch("veritasreason.ontology.engine.get_logger", return_value=MagicMock()), \
             patch("veritasreason.ontology.engine.get_progress_tracker", return_value=mock_progress), \
             patch("veritasreason.ontology.ontology_generator.get_logger", return_value=MagicMock()), \
             patch("veritasreason.ontology.ontology_generator.get_progress_tracker", return_value=mock_progress):
            from veritasreason.ontology.engine import OntologyEngine
    ...
    def test_shacl_validation_report_summary_conforms(self):
        from veritasreason.ontology.ontology_validator import SHACLValidationReport
    ...
    def test_shacl_validation_report_summary_violations(self):
        from veritasreason.ontology.ontology_validator import (
    ...
    def test_shacl_violation_to_dict(self):
        from veritasreason.ontology.ontology_validator import SHACLViolation
        v = SHACLViolation(
