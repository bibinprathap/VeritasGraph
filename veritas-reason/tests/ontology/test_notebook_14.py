...
class TestNotebook14(unittest.TestCase):
    ...
    def _run_full_pipeline(self):
        ...
        engine = OntologyEngine(base_uri="https://docs.veritasreason.dev/ontology/")
    ...
    @patch("veritasreason.visualization.ontology_visualizer.make_subplots")
    @patch("veritasreason.visualization.ontology_visualizer.go")
    ...
    @patch("veritasreason.ontology.llm_generator.LLMOntologyGenerator.generate_ontology_from_text")
