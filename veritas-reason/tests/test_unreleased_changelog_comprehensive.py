...
class TestAuditTrailAdditional:
    ...
    def setup(self):
        from veritasreason.context import ContextGraph
        from veritasreason.change_management.managers import TemporalVersionManager
        graph = ContextGraph()
        manager = TemporalVersionManager()
...
class TestRollbackProtectionAdditional:
    ...
    def test_restore_requires_confirmation_by_default(self, setup_with_snapshot):
        from veritasreason.change_management.managers import ProcessingError
...
class TestRDFExporterExportSHACL:
    ...
    def test_export_shacl_writes_ttl_file(self, tmp_path):
        from veritasreason.export.rdf_exporter import RDFExporter
...
class TestDatalogReasonerGap:
    ...
    @pytest.fixture
    def reasoner(self):
        from veritasreason.reasoning import DatalogReasoner
