...
class TestProvenanceEnabledDisabled:
    ...
    def test_all_modules_support_provenance_false(self):
        ...
        modules_to_test = [
            ('veritasreason.context.context_provenance', 'ContextManagerWithProvenance'),
            ('veritasreason.pipeline.pipeline_provenance', 'PipelineWithProvenance'),
        ]
...
class TestAllModulesEdgeCases:
    ...
    def test_all_modules_handle_none_config(self):
        ...
        modules = [
            ('veritasreason.context.context_provenance', 'ContextManagerWithProvenance'),
            ('veritasreason.embeddings.embeddings_provenance', 'EmbeddingGeneratorWithProvenance'),
        ]
    ...
    def test_all_modules_graceful_import_failure(self):
        ...
        modules = [
            'veritasreason.context.context_provenance',
            'veritasreason.pipeline.pipeline_provenance',
            'veritasreason.embeddings.embeddings_provenance',
        ]
    ...
    def test_storage_modules_handle_empty_operations(self):
        ...
        storage_modules = [
            ('veritasreason.graph_store.graph_store_provenance', 'GraphStoreWithProvenance'),
            ('veritasreason.vector_store.vector_store_provenance', 'VectorStoreWithProvenance'),
            ('veritasreason.triplet_store.triplet_store_provenance', 'TripletStoreWithProvenance'),
        ]
