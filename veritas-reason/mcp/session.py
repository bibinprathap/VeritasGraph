...
lifetime of the MCP server process.  Set VERITASREASON_KG_PATH to
...
log = logging.getLogger("veritasreason.mcp.session")
...
def get_graph() -> Any:
    ...
    if _graph is None:
        ...
        kg_path = os.environ.get("VERITASREASON_KG_PATH", "").strip()
