"""
Resource handlers for VeritasReason MCP resources.

Each resource maps a veritasreason:// URI to a callable that returns
{"uri": ..., "mimeType": ..., "text": ...}.
"""
...
log = logging.getLogger("veritasreason.mcp.resources")
...
_HANDLERS: dict[str, object] = {
    "veritasreason://graph/summary": _read_graph_summary,
    "veritasreason://decisions/list": _read_decisions_list,
    "veritasreason://schema/info": _read_schema_info,
    "veritasreason://ontology/schema": _read_ontology_schema,
}
...
RESOURCE_DEFINITIONS = [
    ...
    },
    {
        ...
        "name": "Schema Info",
        "description": "VeritasReason schema version, supported node/edge types, and available tool names.",
        "mimeType": "application/json",
    },
    {
        "uri": "veritasreason://ontology/schema",
