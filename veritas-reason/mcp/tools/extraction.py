...
log = logging.getLogger("veritasreason.mcp.tools.extraction")
...
def handle_extract_entities(args: dict) -> dict:
    """Extract named entities from text using VeritasReason NER."""
...
EXTRACTION_TOOLS = [
    ...
    {
        "name": "extract_all",
        "description": "Run the full VeritasReason extraction pipeline: NER, coreference resolution, relation extraction, event detection, and triplet generation.",
