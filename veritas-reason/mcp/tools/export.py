...
log = logging.getLogger("veritasreason.mcp.tools.export")
...
def handle_export_graph(args: dict) -> dict:
    ...
    try:
        ...
        if fmt in ("graphml",):
            try:
                from veritasreason.export import GraphMLExporter
...
EXPORT_TOOLS = [
    {
        "name": "export_graph",
        "description": (
            "Export the VeritasReason knowledge graph to JSON, CSV, GraphML, Parquet, "
