...
log = logging.getLogger("veritasreason.mcp.tools.decisions")
...
DECISION_TOOLS = [
    {
        ...
        "description": "Record a decision with full context, causal links, and metadata into the VeritasReason knowledge graph.",
