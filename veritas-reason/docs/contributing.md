...
- Share VeritasReason in your blog posts or talks
...
Include: what happened, steps to reproduce, expected behavior, and your environment (Python version, OS, VeritasReason version).

### Feature Requests

Include: your use case, what you'd like VeritasReason to do, and how it benefits others.
