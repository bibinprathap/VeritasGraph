...
Reference of terms and concepts used throughout VeritasReason.
...
### **Agent**
An autonomous AI system that can perceive its environment, reason about information, and take actions to achieve specific goals. In VeritasReason, agents use knowledge graphs for memory and reasoning.
