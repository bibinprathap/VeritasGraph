...
Structured learning paths, quick references, and performance guidance for going deeper with VeritasReason.
...
-   :material-school: **Beginner** (1–2 hours)
    ---
    New to VeritasReason and knowledge graphs.
...
| Embedding Provider | `VERITASREASON_EMBEDDING_PROVIDER` | `"openai"` |
| Graph Backend | `VERITASREASON_GRAPH_BACKEND` | `"networkx"` |
...
-   :material-alert: **Import Errors**
    ...
    Verify installation: `pip list | grep veritasreason`. Ensure Python 3.8+.
