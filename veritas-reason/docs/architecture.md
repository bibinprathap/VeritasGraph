...
VeritasReason is built around a three-layer, modular architecture designed for independent use of components, clean separation of concerns, and extensibility at each layer.
