...
Essential guides to master the VeritasReason framework.

<div class="grid cards" markdown>

-   :material-hand-wave: **Welcome to VeritasReason**
    ---
...
1.  **Install VeritasReason from PyPI** (recommended):
    ```bash
...
!!! tip "Using Docker"
    ...
    ```bash
    docker run -p 8888:8888 hawksight/veritasreason-cookbook
    ```
