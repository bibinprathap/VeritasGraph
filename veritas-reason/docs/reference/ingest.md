...
The **Ingest Module** is the entry point for loading data into VeritasReason. It provides universal data ingestion from files, web content, feeds, streams, repositories, emails, databases, and more.

### What is Data Ingestion?

**Data ingestion** is the process of loading data from various sources into VeritasReason for processing. The ingest module handles:
...
!!! tip "When to Use"
    - **Data Onboarding**: The entry point for all external data into VeritasReason
...
```bash
export INGEST_USER_AGENT="VeritasReasonBot/1.0"
...
```python
from veritasreason.ingest import FeedIngestor
