...
!!! tip "Prerequisites"
    VeritasReason installed (`pip install veritas-reason`). If not, see the [Installation Guide](installation.md).
...
| Slow processing | Process in chunks; use GPU acceleration (`pip install veritas-reason[gpu]`) |
