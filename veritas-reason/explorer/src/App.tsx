          ...
          <div className="landing-copy">
            <div>
              ...
              <p className="landing-subtitle">
                VeritasReason turns dense knowledge graphs into a navigable command center for discovery,
            ...
            <div className="landing-metrics" aria-label="VeritasReason live status">
              {metrics.map((metric) => (
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <div className="app-shell">
        <aside className="app-rail">
          <button className="brand-pill" title="VeritasReason Knowledge Explorer" onClick={() => setActiveWorkspace('welcome')} style={{ cursor: 'pointer', border: '1px solid rgba(127,208,255,0.18)' }}>SKE</button>
