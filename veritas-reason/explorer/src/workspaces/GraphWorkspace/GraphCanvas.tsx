...
import {
  VERITASREASON_EDGE_PROGRAM_CLASSES,
  VERITASREASON_NODE_PROGRAM_CLASSES,
  drawVeritasReasonNodeHover,
  drawVeritasReasonNodeLabel,
...
const SIGMA_SETTINGS = {
  ...
  nodeProgramClasses: VERITASREASON_NODE_PROGRAM_CLASSES,
  edgeProgramClasses: VERITASREASON_EDGE_PROGRAM_CLASSES,
  defaultDrawNodeLabel: drawVeritasReasonNodeLabel,
  defaultDrawNodeHover: drawVeritasReasonNodeHover,
};
