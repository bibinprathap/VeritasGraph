---
name: validate
description: Validate VeritasReason pipelines, extraction quality, graph schemas, and ontology consistency. Returns structured error/warning checklists. Uses PipelineValidator, PipelineBuilder.validate_pipeline(), GraphValidator, and OntologyValidator. Sub-commands: pipeline, step, dependencies, extraction, graph, ontology, performance.
---

# /veritasreason:validate

Validate pipeline and graph quality. Usage: `/veritasreason:validate <target> [options]`
...
```python
from veritasreason.pipeline.pipeline_builder import PipelineBuilder
from veritasreason.pipeline.pipeline_validator import PipelineValidator
...
```python
from veritasreason.semantic_extract.extraction_validator import ExtractionValidator
...
```python
from veritasreason.kg.graph_validator import GraphValidator
...
```python
from veritasreason.ontology import OntologyValidator
