---
name: reason
description: Run reasoning over the VeritasReason knowledge graph — deductive logic, abductive hypothesis generation, Datalog programs, SPARQL queries, Rete network evaluation. Uses DeductiveReasoner, AbductiveReasoner, DatalogReasoner, SPARQLReasoner, ReteEngine. Sub-commands: deductive, abductive, datalog, sparql, rete, prove, hypotheses.
---

# /veritasreason:reason

Apply reasoning over the knowledge graph. Usage: `/veritasreason:reason <mode> [args]`
...
```python
from veritasreason.reasoning.deductive_reasoner import DeductiveReasoner, Premise
...
```python
from veritasreason.reasoning.abductive_reasoner import (
...
```python
from veritasreason.reasoning.datalog_reasoner import DatalogReasoner
...
```python
from veritasreason.reasoning.sparql_reasoner import SPARQLReasoner
from veritasreason.context import ContextGraph
...
```python
from veritasreason.reasoning.rete_engine import ReteEngine
import json
...
```python
from veritasreason.reasoning.abductive_reasoner import AbductiveReasoner, Observation
import json
