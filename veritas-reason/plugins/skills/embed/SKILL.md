...
Generate and inspect graph embeddings. Usage: `/veritasreason:embed <sub-command> [args]`
...
```python
from veritasreason.kg.similarity_calculator import SimilarityCalculator
from veritasreason.kg.node_embeddings import NodeEmbedder
from veritasreason.context import ContextGraph
