...
1. Read the YAML metadata and identify whether the request matches VeritasReason graph, context graph, decision intelligence, or extraction tasks.
2. Load this Skill when the request mentions VeritasReason, knowledge graphs, context graphs, decision intelligence, explainability, reasoning, or provenance.
