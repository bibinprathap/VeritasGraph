...
```bash
pytest                          # Run tests
black veritasreason/ tests/        # Format code
isort veritasreason/ tests/         # Sort imports
flake8 veritasreason/ tests/        # Lint
```
...
|----------|----------------------------|----------------------------|
| **Black** | Code formatting            | `black veritasreason/ tests/` |
| **isort** | Import sorting             | `isort veritasreason/ tests/` |
| **flake8** | Style enforcement          | `flake8 veritasreason/ tests/` |
| **mypy** | Type checking              | `mypy veritasreason/`          |

**Run all:** `black veritasreason/ tests/ && isort veritasreason/ tests/ && flake8 veritasreason/ tests/ && mypy veritasreason/`
...
pytest --cov=veritasreason         # With coverage
...
```python
from veritasreason import SomeClass
